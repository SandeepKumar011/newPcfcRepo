...
const portName=uatData.sixDataCompany.portName
const gateType=uatData.sixDataCompany.gateType
const passDuration=uatData.sixDataCompany.passDuration
const passType=uatData.sixDataCompany.passType
const reasonVisit=uatData.sixDataCompany.visitReason
const hCompany=uatData.sixDataCompany.hostCompany
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const usernameLogin=uatData.sixDataCompany.username
const passwordLogin=uatData.sixDataCompany.password
const approvalusername=uatData.sixDataCompany.approveUsername
const approvalpassword=uatData.sixDataCompany.approvePassword
const approvalusername2=uatData.sixDataCompany.approveUsername2
const approvalpassword2=uatData.sixDataCompany.approvePassword2
const approvalusername3=uatData.sixDataCompany.approveUsername3
const approvalpassword3=uatData.sixDataCompany.approvePassword3
const approvalusername4=uatData.sixDataCompany.approveUsername4
const approvalpassword4=uatData.sixDataCompany.approvePassword4
...
Given('user navigates to the login page for company for six Month', async ({page}) => {
  ...
  Then('user redirected to the home page for company for six Month', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  Then('user save the visitor on the add page for the company for six month', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  Then('verify user is added in the list for the company for six month', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await expect(pageConstants.passPage.editButton).toBeVisible();
  });
  
  When('user submit the visitor information for the company for six month', async ({page}) => {
    const pageConstants = new PageConstants(page);
...
When(/^user select logout button on home page for the company for six month$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForTimeout(2000);
...
Then(/^verify logout verification message for the company for six month$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
