...
When('user enter pass information for one week pass', async ({page}) => {       
  ...
  When('user enter the visitor information for one week pass', async ({page}) => {
          const pageConstants = new PageConstants(page);
          await page.waitForTimeout(2000);
  ...
  When('user save the visitor for one week pass', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  Then('verify user is added in the list for one week pass', async ({page}) => {  
    const pageConstants = new PageConstants(page);
    await expect(pageConstants.passPage.editButton).toBeVisible();
  });
  
  When('user submit the visitor information for one week pass', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  When('user select logout button on home page for one week pass', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForTimeout(2000);
  ...
  Then('verify logout verification message for one week pass', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
    await page.waitForTimeout(2000);
  ...
  When('user approve the apply pass for one week pass', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
    await page.waitForTimeout(10000);
