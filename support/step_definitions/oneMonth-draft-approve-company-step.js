...
const portName=uatData.DraftCompanyData.portName
const gateType=uatData.DraftCompanyData.gateType
const passDuration=uatData.DraftCompanyData.passDuration
const passType=uatData.DraftCompanyData.passType
const reasonVisit=uatData.DraftCompanyData.visitReason
const hCompany=uatData.DraftCompanyData.hostCompany
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const usernameLogin=uatData.DraftCompanyData.username
const passwordLogin=uatData.DraftCompanyData.password
const approvalusername=uatData.DraftCompanyData.approveUsername
const approvalpassword=uatData.DraftCompanyData.approvePassword
const approvalusername2=uatData.DraftCompanyData.approveUsername2
const approvalpassword2=uatData.DraftCompanyData.approvePassword2
const approvalusername3=uatData.DraftCompanyData.approveUsername3
const approvalpassword3=uatData.DraftCompanyData.approvePassword3
const approvalusername4=uatData.DraftCompanyData.approveUsername4
const approvalpassword4=uatData.DraftCompanyData.approvePassword4
