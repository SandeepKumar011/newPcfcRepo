...
const portName=uatData.twoMonthDataHost.portName
const gateType=uatData.twoMonthDataHost.gateType
const passDuration=uatData.twoMonthDataHost.passDuration
const passType=uatData.twoMonthDataHost.passType
const reasonVisit=uatData.twoMonthDataHost.visitReason
const hCompany=uatData.twoMonthDataHost.hostCompany
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const usernameLogin=uatData.twoMonthDataHost.username
const passwordLogin=uatData.twoMonthDataHost.password
const approvalusername=uatData.twoMonthDataHost.approveUsername1
const approvalpassword=uatData.twoMonthDataHost.approvePassword1
const approvalusername4=uatData.twoMonthDataHost.approveUsername4
const approvalpassword4=uatData.twoMonthDataHost.approvePassword4
