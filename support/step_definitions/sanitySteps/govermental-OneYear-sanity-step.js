...
const portName=uatData.sanityDataGovernment.portName;
const gateType=uatData.sanityDataGovernment.gateType;
const passType=uatData.sanityDataGovernment.passType;
const passDuration=uatData.sanityDataGovernment.passDuration;
const reasonVisit=uatData.sanityDataGovernment.visitReason;
const hCompany=uatData.sanityDataGovernment.hostCompany;
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const gevernmentusername=uatData.sanityDataGovernment.gevernmentUserName;
const governmentpassword=uatData.sanityDataGovernment.gevernmentPassword;
const govapprovalUsername1=uatData.sanityDataGovernment.approvalUsername1
const govapprovalpassword1=uatData.sanityDataGovernment.approvalPassword1
const govapprovalUsername2=uatData.sanityDataGovernment.approvalUsername2;
const govapprovalpassword2=uatData.sanityDataGovernment.approvalPassword2;
const govapprovalUsername3=uatData.sanityDataGovernment.approvalUsername3;
const govapprovalpassword3=uatData.sanityDataGovernment.approvalPassword3;
const govapprovalUsername4=uatData.sanityDataGovernment.approvalUsername4
const govapprovalpassword4=uatData.sanityDataGovernment.approvalPassword4
