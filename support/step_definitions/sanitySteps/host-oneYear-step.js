...
const portName=uatData.sanityDataHostOneYear.portName
const gateType=uatData.sanityDataHostOneYear.gateType
const passDuration=uatData.sanityDataHostOneYear.passDuration
const passType=uatData.sanityDataHostOneYear.passType
const reasonVisit=uatData.sanityDataHostOneYear.visitReason
const hCompany=uatData.sanityDataHostOneYear.hostCompany
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const approvalusername1=uatData.sanityDataHostOneYear.approveUsername1
const approvalpassword1=uatData.sanityDataHostOneYear.approvePassword1
const approvalusername2=uatData.sanityDataHostOneYear.approveUsername2
const approvalpassword2=uatData.sanityDataHostOneYear.approvePassword2
const approvalusername4=uatData.sanityDataHostOneYear.approveUsername4
const approvalpassword4=uatData.sanityDataHostOneYear.approvePassword4
const hostusername=uatData.sanityDataHostOneYear.hostUsername
const hostpassword=uatData.sanityDataHostOneYear.hostPassword
