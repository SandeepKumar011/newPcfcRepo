...
const portName=uatData.sanityDataContractor.portName;
const gateType=uatData.sanityDataContractor.gateType;
const passDuration=uatData.sanityDataContractor.passDuration;
const passType=uatData.sanityDataContractor.passType;
const reasonVisit=uatData.sanityDataContractor.visitReason;
const hCompany=uatData.sanityDataContractor.hostCompany;
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const contractorusername=uatData.sanityDataContractor.contractorUserName;
const contractorpassword=uatData.sanityDataContractor.contractorPassword;
const contrapprovalUsername1=uatData.sanityDataContractor.approvalUsername1
const contrapprovalpassword1=uatData.sanityDataContractor.approvalPassword1
const contrapprovalUsername2=uatData.sanityDataContractor.approvalUsername2
const contrapprovalpassword2=uatData.sanityDataContractor.approvalPassword2
const contrapprovalUsername4=uatData.sanityDataContractor.approveUsername4
const contrapprovalpassword4=uatData.sanityDataContractor.approvePassword4
...
Then(/^verify Final approval successfully message for contractor$/, async({page}) => {
  //as of now there is not credenatial
  // const pageConstants = new PageConstants(page);
  // await page.waitForLoadState("networkidle");
  // await page.waitForTimeout(2000);
  // await pageConstants.loginPage.logoutDrop.click();
