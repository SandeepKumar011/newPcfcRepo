...
const portName=uatData.sanityDataCompany.portName
const gateType=uatData.sanityDataCompany.gateType
const passDuration=uatData.sanityDataCompany.passDuration
const passType=uatData.sanityDataCompany.passType
const reasonVisit=uatData.sanityDataCompany.visitReason
const hCompany=uatData.sanityDataCompany.hostCompany
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const usernameLogin=uatData.sanityDataCompany.username
const passwordLogin=uatData.sanityDataCompany.password
const approvalusername=uatData.sanityDataCompany.approveUsername
const approvalpassword=uatData.sanityDataCompany.approvePassword
const approvalusername2=uatData.sanityDataCompany.approveUsername2
const approvalpassword2=uatData.sanityDataCompany.approvePassword2
const approvalusername3=uatData.sanityDataCompany.approveUsername3
const approvalpassword3=uatData.sanityDataCompany.approvePassword3
...
Then('verify final status completed for the applyied pass', async ({page}) => {
    //as of now there is no credential
    // const pageConstants = new PageConstants(page);
    // await page.waitForTimeout(2000);
    // await pageConstants.loginPage.logoutDrop.click();
    // await pageConstants.loginPage.logoutButton.click();
