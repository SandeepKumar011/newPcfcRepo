...
const portName=oneDayData.renewDataIndividual.portName
const gateType=oneDayData.renewDataIndividual.gateType
const passDuration=oneDayData.renewDataIndividual.passDuration
const passType=oneDayData.renewDataIndividual.passType
const reasonVisit=oneDayData.renewDataIndividual.visitReason
const hCompany=oneDayData.renewDataIndividual.hostCompany
const username=oneDayData.renewDataIndividual.username
const password=oneDayData.renewDataIndividual.password
const actualEid=oneDayData.renewDataIndividual.existingEid
...
Given('user navigates to the login page for renew individual', async ({}) => {      
  ...
  When('user enter the credential for the login for renew individual', async ({}) => {
             const pageConstants = new PageConstants(page);
             await page.waitForLoadState("networkidle");
  ...
  Then('user redirected to the home page for renew individual', async ({}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  When('user search the pass for the renew pass individual', async ({}) => {
    const pageConstants = new PageConstants(page);
     await page.waitForLoadState("networkidle");
     await page.waitForTimeout(5000);
     referceNumber=oneDayData.renewDataIndividual.expiredEid
     await pageConstants.passPage.searchForPassRefence.type(referceNumber);
  });
  
  When('user entere the infomration for renew pass individual', async ({}) => {
      const pageConstants = new PageConstants(page);
       await page.waitForLoadState("networkidle");
  ...
  When('user submit the visitor information for the renew pass individual', async ({}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  When('user paid amount for the apply pass for the renew pass individual', async ({}) => {
    console.log('for one day pass there is not need for the payment');
  });
  
  Then('verify successfully messge for the renew pass individual', async ({}) => {
       const pageConstants = new PageConstants(page);
       await page.waitForLoadState("networkidle");
