...
const portName=uatData.renewDataIndividual.portName
const gateType=uatData.renewDataIndividual.gateType
const passDuration=uatData.renewDataIndividual.passDuration
const passType=uatData.renewDataIndividual.passType
const reasonVisit=uatData.renewDataIndividual.visitReason
const hCompany=uatData.renewDataIndividual.hostCompany
const username=uatData.renewDataIndividual.username
const password=uatData.renewDataIndividual.password
const actualEid=uatData.renewDataIndividual.existingEid
