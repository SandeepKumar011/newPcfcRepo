...
const portName=uatData.renewDataHost.portName
const gateType=uatData.renewDataHost.gateType
const passDuration=uatData.renewDataHost.passDuration
const passType=uatData.renewDataHost.passType
const reasonVisit=uatData.renewDataHost.visitReason
const hCompany=uatData.renewDataHost.hostCompany
const username=uatData.renewDataHost.username
const password=uatData.renewDataHost.password
const actualEid=uatData.renewDataHost.existingEid
