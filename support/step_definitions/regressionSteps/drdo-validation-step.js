...
const portName=oneMonthData.drdoDataCompany.portName
const gateType=oneMonthData.drdoDataCompany.gateType
const passDuration=oneMonthData.drdoDataCompany.passDuration
const passType=oneMonthData.drdoDataCompany.passType
const reasonVisit=oneMonthData.drdoDataCompany.visitReason
const hCompany=oneMonthData.drdoDataCompany.hostCompany
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const usernameLogin=oneMonthData.drdoDataCompany.username
const passwordLogin=oneMonthData.drdoDataCompany.password
const approvalusername=oneMonthData.drdoDataCompany.approveUsername
const approvalpassword=oneMonthData.drdoDataCompany.approvePassword
const approvalusername2=oneMonthData.drdoDataCompany.approveUsername2
const approvalpassword2=oneMonthData.drdoDataCompany.approvePassword2
const approvalusername3=oneMonthData.drdoDataCompany.approveUsername3
const approvalpassword3=oneMonthData.drdoDataCompany.approvePassword3
const approvalusername4=oneMonthData.drdoDataCompany.approveUsername4
const approvalpassword4=oneMonthData.drdoDataCompany.approvePassword4
...
Given('user navigates to the login page for company DRDO', async ({page}) => {
  ...
  When('user enter the credential for the login for company DRDO', async ({page}) => {     
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  Then('user redirected to the home page for company DRDO', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  Then('Enter the pass information for the company DRDO', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
 ...
 await selectDatedob.click();
  ...
  Then('user enter the visitor information for the company DRDO', async ({page}) => {
    const pageConstants = new PageConstants(page);
          await page.waitForTimeout(2000);
  ...
  Then('user save the visitor on the add page for the company DRDO', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  Then('verify user is added in the list for the company DRDO', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await expect(pageConstants.passPage.editButton).toBeVisible();
  });
  
  When('user submit the visitor information for the company DRDO', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  When('user paid amount for the apply pass for the company DRDO', async ({page}) => {
    const pageConstants = new PageConstants(page);
          await page.waitForLoadState("networkidle");
          await page.waitForTimeout(10000);
  ...
  Then('verify pass apply successfully messge for the company DRDO', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
...
When(/^user select logout button on home page for the company DRDO$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForTimeout(2000);
...
Then(/^verify logout verification message for the company DRDO$/, async({page}) => {
	const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
    await expect(pageConstants.loginPage.enterUsername).toBeVisible();
});

When(/^user approve the apply pass on the list page for the company DRDO$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
    await page.waitForTimeout(5000);
...
Then(/^verify pass approved successfully message for the company DRDO$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
    await page.waitForTimeout(5000);
...
When(/^verify second second approval message for the company DRDO$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForTimeout(2000);
    await pageConstants.loginPage.logoutDrop.click();
    await pageConstants.loginPage.logoutButton.click();
...
When(/^verify Third approval message for the company DRDO$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForTimeout(2000);
    await pageConstants.loginPage.logoutDrop.click();
    await pageConstants.loginPage.logoutButton.click();
...
Then(/^verify final status completed for the applyied pass for DRDO$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForTimeout(2000);
    await pageConstants.loginPage.logoutDrop.click();
    await pageConstants.loginPage.logoutButton.click();
