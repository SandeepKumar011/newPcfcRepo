...
const portName=uatData.drdoDataCompany.portName
const gateType=uatData.drdoDataCompany.gateType
const passDuration=uatData.drdoDataCompany.passDuration
const passType=uatData.drdoDataCompany.passType
const reasonVisit=uatData.drdoDataCompany.visitReason
const hCompany=uatData.drdoDataCompany.hostCompany
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const usernameLogin=uatData.drdoDataCompany.username
const passwordLogin=uatData.drdoDataCompany.password
const approvalusername=uatData.drdoDataCompany.approveUsername
const approvalpassword=uatData.drdoDataCompany.approvePassword
const approvalusername2=uatData.drdoDataCompany.approveUsername2
const approvalpassword2=uatData.drdoDataCompany.approvePassword2
const approvalusername3=uatData.drdoDataCompany.approveUsername3
const approvalpassword3=uatData.drdoDataCompany.approvePassword3
const approvalusername4=uatData.drdoDataCompany.approveUsername4
const approvalpassword4=uatData.drdoDataCompany.approvePassword4
