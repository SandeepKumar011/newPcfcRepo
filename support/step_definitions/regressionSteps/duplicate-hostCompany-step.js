...
const portName=oneDayData.duplicateOneDayDataHostCompany.portName
const gateType=oneDayData.duplicateOneDayDataHostCompany.gateType
const passDuration=oneDayData.duplicateOneDayDataHostCompany.passDuration
const passType=oneDayData.duplicateOneDayDataHostCompany.passType
const reasonVisit=oneDayData.duplicateOneDayDataHostCompany.visitReason
const hCompany=oneDayData.duplicateOneDayDataHostCompany.hostCompany
const username=oneDayData.duplicateOneDayDataHostCompany.username
const password=oneDayData.duplicateOneDayDataHostCompany.password
const approverusername=oneDayData.duplicateOneDayDataHostCompany.approveUsername
const approverpassword=oneDayData.duplicateOneDayDataHostCompany.approvePassword
const actualEid=oneDayData.duplicateOneDayDataHostCompany.existingEid
...
Given('user navigates to the login page for duplicate', async ({page}) => {   
  ...
  When('user enter credential on login page for duplicate', async ({page}) => {
         const pageConstants = new PageConstants(page);
         await page.waitForLoadState("networkidle");
  ...
  Then('verify user is redirected to the home page for duplicate', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  When('user select Apply gate pass on the management pass page for duplicate', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  When('user enter pass information on the create page for duplicate', async ({page}) => {
        const pageConstants = new PageConstants(page);
        await page.waitForLoadState("networkidle");
  ...
  When('user enter the visitor information on the create page for duplicate', async ({page}) => {
              const pageConstants = new PageConstants(page);
              await page.waitForTimeout(2000);
  ...
  When('user save the visitor on the create page for duplicate', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  Then('verify user is added in the list on the create page for duplicate', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await expect(pageConstants.passPage.editButton).toBeVisible();
  });
  
  When('user submit the visitor information on the create page for duplicate', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  Then('verify pass apply successfully messge for duplicate', async ({page}) => {
      const pageConstants = new PageConstants(page);
      await page.waitForLoadState("networkidle");
...
When(/^user select logout button on home page for duplicate$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForTimeout(2000);
...
Then(/^verify logout verification message for duplicate$/, async({page}) => {
	const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
    await expect(pageConstants.loginPage.enterUsername).toBeVisible();
});

When(/^user approve the apply pass on the list page for duplicate$/, async({page}) => {
	    const pageConstants = new PageConstants(page);
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(5000);
...
Then(/^verify pass approved successfully message for duplicate$/, async({page}) => {
	          const pageConstants = new PageConstants(page);
              await page.waitForLoadState("networkidle");
              await page.waitForTimeout(5000);
...
When(/^user select again apply pass for duplicate check$/, async({page}) => {
	const pageConstants = new PageConstants(page);
    await page.waitForTimeout(2000);
    await pageConstants.loginPage.logoutDrop.click();
    await pageConstants.loginPage.logoutButton.click();
...
When(/^user enter all the information for duplicate pass$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
    await page.waitForTimeout(5000);
    await page.waitForSelector(`//select[@id='portsId']`, { state: 'visible' });
...
When(/^user enter the visitor infomation for the duplicate pass$/, async({page}) => {
	 const pageConstants = new PageConstants(page);
        await page.waitForTimeout(2000);
        const dropdownVisa = page.locator("//select[@id='searchVisaTypeIdStr']");
        await dropdownVisa.selectOption({ label: 'Resident' });
...
When(/^user submit the duplicate pass for message$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await pageConstants.passPage.addVisitor.click();
    await page.waitForTimeout(10000);
    await (pageConstants.passPage.termsAndCondiUi).click();
...
Then(/^verify duplicate message display on the submit page$/, async({page}) => {
