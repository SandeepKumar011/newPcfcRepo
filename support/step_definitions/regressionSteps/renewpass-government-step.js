...
const portName=oneDayData.renewDataGov.portName
const gateType=oneDayData.renewDataGov.gateType
const passDuration=oneDayData.renewDataGov.passDuration
const passType=oneDayData.renewDataGov.passType
const reasonVisit=oneDayData.renewDataGov.visitReason
const hCompany=oneDayData.renewDataGov.hostCompany
const username=oneDayData.renewDataGov.username
const password=oneDayData.renewDataGov.password
const actualEid=oneDayData.renewDataGov.existingEid
