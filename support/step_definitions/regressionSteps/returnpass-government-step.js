...
const portName=uatData.regressionDataGov.portName
const gateType=uatData.regressionDataGov.gateType
const passDuration=uatData.regressionDataGov.passDuration
const passType=uatData.regressionDataGov.passType
const reasonVisit=uatData.regressionDataGov.visitReason
const hCompany=uatData.regressionDataGov.hostCompany
const username=uatData.regressionDataGov.username
const password=uatData.regressionDataGov.password
const approvalusername=uatData.regressionDataGov.approveUsername
const approvalpassword=uatData.regressionDataGov.approvePassword
