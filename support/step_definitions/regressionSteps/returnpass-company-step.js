...
const portName=uatData.regressionDataCompany.portName
const gateType=uatData.regressionDataCompany.gateType
const passDuration=uatData.regressionDataCompany.passDuration
const passType=uatData.regressionDataCompany.passType
const reasonVisit=uatData.regressionDataCompany.visitReason
const hCompany=uatData.regressionDataCompany.hostCompany
const username=uatData.regressionDataCompany.username
const password=uatData.regressionDataCompany.password
const approvalusername=uatData.regressionDataCompany.approveUsername
const approvalpassword=uatData.regressionDataCompany.approvePassword
...
Given('user navigates the login page for company return', async ({page}) => {
  ...
  When('user enter the crendential for the company return', async ({page}) => {
    const pageConstants = new PageConstants(page);
     await page.waitForLoadState("networkidle");
  ...
  Then('user should be redirected to the home page for company return', async ({page}) => {
    const pageConstants = new PageConstants(page);
  await page.waitForLoadState("networkidle");
  ...
  When('user enter the infomation for pass for company return', async ({page}) => {
        const pageConstants = new PageConstants(page);
...
When('user enter infomation for the visitor for company return', async ({page}) => {
     const pageConstants = new PageConstants(page);
     await page.waitForTimeout(2000);
  ...
  When('user apply the pass for one day for company return', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  When('user payment for the apply pass on payment page for return', async ({page}) => {
     console.log('there is not need to pay');
  });
  
  Then('verify confirmation message for company return', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  When('login with the approval crendential for company', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForTimeout(2000);
  ...
  When('host company return pass to the company', async ({page}) => {
          const pageConstants = new PageConstants(page);
          await page.waitForLoadState("networkidle");
  ...
  Then('verify retun confirmation message for the company', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
    await page.waitForTimeout(2000);
    await expect(pageConstants.passPage.amendementMessageSuccess).toBeVisible();
    referceNumber=await page.innerText("(//td[@class='detail-value'])[1]");
    console.log('this is return refence number'+ referceNumber);
  });