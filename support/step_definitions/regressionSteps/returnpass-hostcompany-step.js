...
const portName=oneDayData.regressionDataHost.portName
const gateType=oneDayData.regressionDataHost.gateType
const passDuration=oneDayData.regressionDataHost.passDuration
const passType=oneDayData.regressionDataHost.passType
const reasonVisit=oneDayData.regressionDataHost.visitReason
const hCompany=oneDayData.regressionDataHost.hostCompany
const username=oneDayData.regressionDataHost.username
const password=oneDayData.regressionDataHost.password
const approvalusername=oneDayData.regressionDataHost.approveUsername
const approvalpassword=oneDayData.regressionDataHost.approvePassword
...
Given('user navigates the login page for hostcompany return', async ({page}) => {
  ...
  When('user enter the crendential for the hostcompany return', async ({page}) => {
   const pageConstants = new PageConstants(page);
         await page.waitForLoadState("networkidle");
  ...
  Then('user should be redirected to the home page for hostcompany return', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  When('user enter the infomation for pass for hostcompany return', async ({page}) => {
     const pageConstants = new PageConstants(page);
  ...
  When('user enter infomation for the visitor for hostcompany return', async ({page}) => {
   const pageConstants = new PageConstants(page);
           await page.waitForTimeout(2000);
  ...
  When('user apply the pass for one day for hostcompany return', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  When('user pay amount for the retun pass for hostcompany', async ({page}) => {
    console.log('there is not need to pay');
  });
  
  Then('verify confirmation message for hostcompany return', async ({page}) => {
     const pageConstants = new PageConstants(page);
          await page.waitForLoadState("networkidle");
  ...
  When('login with the approval crendential for hostcompany', async ({page}) => {
    const pageConstants = new PageConstants(page);
         await page.waitForTimeout(2000);
  ...
  When('host company return pass to the hostcompany', async ({page}) => {
   const pageConstants = new PageConstants(page);
              await page.waitForLoadState("networkidle");
