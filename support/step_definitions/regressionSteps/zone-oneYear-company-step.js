...
const portName=oneYearData.zoneDataCompany.portName
const gateType=oneYearData.zoneDataCompany.gateType
const passDuration=oneYearData.zoneDataCompany.passDuration
const passType=oneYearData.zoneDataCompany.passType
const reasonVisit=oneYearData.zoneDataCompany.visitReason
const hCompany=oneYearData.zoneDataCompany.hostCompany
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const usernameLogin=oneYearData.zoneDataCompany.username
