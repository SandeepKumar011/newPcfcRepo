...
Given('user navigates the login page for contractor update profile', async ({page}) => {
  ...
  When('user enter the crendential for the contractor update profile', async ({page}) => {
       const pageConstants = new PageConstants(page);
        await page.waitForLoadState("networkidle");
  ...
  Then('user should be redirected to the home page for contractor update profile', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  When('user select update profile for contractor updated', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForTimeout(2000);
  ...
  When('user update the infomation for contractor', async ({page}) => {
                const pageConstants = new PageConstants(page);
                 await page.waitForTimeout(2000);
  ...
  When('user submit the infomation for contractor', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await pageConstants.passPage.updateButton.click();
  });
  
  Then('verify success messge for the contractor', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
