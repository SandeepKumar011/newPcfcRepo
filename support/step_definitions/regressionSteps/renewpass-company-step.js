...
const portName=oneMonthData.renewCompany.portName
const gateType=oneMonthData.renewCompany.gateType
const passDuration=oneMonthData.renewCompany.passDuration
const passType=oneMonthData.renewCompany.passType
const reasonVisit=oneMonthData.renewCompany.visitReason
const hCompany=oneMonthData.renewCompany.hostCompany
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const usernameLogin=oneMonthData.renewCompany.username
const passwordLogin=oneMonthData.renewCompany.password
const approvalusername=oneMonthData.renewCompany.approveUsername
const approvalpassword=oneMonthData.renewCompany.approvePassword
