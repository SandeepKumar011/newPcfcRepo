...
const portName=uatData.renewDataContractor.portName
const gateType=uatData.renewDataContractor.gateType
const passDuration=uatData.renewDataContractor.passDuration
const passType=uatData.renewDataContractor.passType
const reasonVisit=uatData.renewDataContractor.visitReason
const hCompany=uatData.renewDataContractor.hostCompany
const username=uatData.renewDataContractor.username
const password=uatData.renewDataContractor.password
const actualEid=uatData.renewDataContractor.existingEid
