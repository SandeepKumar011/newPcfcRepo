...
const portName=uatData.zoneDataHost.portName
const gateType=uatData.zoneDataHost.gateType
const passDuration=uatData.zoneDataHost.passDuration
const passType=uatData.zoneDataHost.passType
const reasonVisit=uatData.zoneDataHost.visitReason
const hCompany=uatData.zoneDataHost.hostCompany
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const approvalusername1=uatData.zoneDataHost.approveUsername1
const approvalpassword1=uatData.zoneDataHost.approvePassword1
const approvalusername2=uatData.zoneDataHost.approveUsername2
const approvalpassword2=uatData.zoneDataHost.approvePassword2
const approvalusername3=uatData.zoneDataHost.approveUsername3
const approvalpassword3=uatData.zoneDataHost.approvePassword3
const approvalusername4=uatData.zoneDataHost.approveUsername4
const approvalpassword4=uatData.zoneDataHost.approvePassword4
const hostusername=uatData.zoneDataHost.hostUsername
const hostpassword=uatData.zoneDataHost.hostPassword
...
Given('user navigates to the login page for host for zone six month', async ({page}) => {      
  ...
  Then('user redirected to the home page for host for zone six month', async ({page}) => {       
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  Then('verify user is added in the list for the host for zone six month', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await expect(pageConstants.passPage.editButton).toBeVisible();
  });
  
  When('user submit the visitor information for the host for zone six month', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  When('user paid amount for the apply pass for the host for zone six month', async ({page}) => {
  const pageConstants = new PageConstants(page);
        await page.waitForLoadState("networkidle");
        await page.waitForTimeout(10000);
  ...
  Then('verify pass apply successfully messge for the host for zone six month', async ({page}) => {
   const pageConstants = new PageConstants(page);
             await page.waitForLoadState("networkidle");
