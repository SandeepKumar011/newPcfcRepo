...
const portName=uatData.regressionDataContractor.portName
const gateType=uatData.regressionDataContractor.gateType
const passDuration=uatData.regressionDataContractor.passDuration
const passType=uatData.regressionDataContractor.passType
const reasonVisit=uatData.regressionDataContractor.visitReason
const hCompany=uatData.regressionDataContractor.hostCompany
const username=uatData.regressionDataContractor.username
const password=uatData.regressionDataContractor.password
const actualEid=uatData.regressionDataContractor.existingEid
...
Given('user navigates the login page for contractor', async ({page}) => {
  ...
  When('user enter the crendential for the contractor', async ({page}) => {
    const pageConstants = new PageConstants(page);
     await page.waitForLoadState("networkidle");
  ...
  Then('user should be redirected to the home page for contractor', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  Then('verify confirmation message for contractor', async ({page}) => {
        const pageConstants = new PageConstants(page);
        await page.waitForLoadState("networkidle");
