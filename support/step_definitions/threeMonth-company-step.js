...
const portName=uatData.ThreeMonthDataCompany.portName
const gateType=uatData.ThreeMonthDataCompany.gateType
const passDuration=uatData.ThreeMonthDataCompany.passDuration
const passType=uatData.ThreeMonthDataCompany.passType
const reasonVisit=uatData.ThreeMonthDataCompany.visitReason
const hCompany=uatData.ThreeMonthDataCompany.hostCompany
const visDesignation=faker.helpers.arrayElement(['Ac Technician', 'Account Assistant','Admin']);
const usernameLogin=uatData.ThreeMonthDataCompany.username
const passwordLogin=uatData.ThreeMonthDataCompany.password
const approvalusername=uatData.ThreeMonthDataCompany.approveUsername
const approvalpassword=uatData.ThreeMonthDataCompany.approvePassword
const approvalusername2=uatData.ThreeMonthDataCompany.approveUsername2
const approvalpassword2=uatData.ThreeMonthDataCompany.approvePassword2
const approvalusername3=uatData.ThreeMonthDataCompany.approveUsername3
const approvalpassword3=uatData.ThreeMonthDataCompany.approvePassword3
const approvalusername4=uatData.ThreeMonthDataCompany.approveUsername4
const approvalpassword4=uatData.ThreeMonthDataCompany.approvePassword4
...
Given('user navigates to the login page for company for three Month', async ({page}) => {
...
When(/^user enter the credential for the login for company three Month$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  Then('user redirected to the home page for company for three Month', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
  ...
  Then('user enter the visitor information for the company for three month', async ({page}) => {
          const pageConstants = new PageConstants(page);
          await page.waitForTimeout(2000);
  ...
  Then('user save the visitor on the add page for the company for three month', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  Then('verify user is added in the list for the company for three month', async ({page}) => {
    const pageConstants = new PageConstants(page);
    await expect(pageConstants.passPage.editButton).toBeVisible();
  });
  
  When('user submit the visitor information for the company for three month', async ({page}) => {
    const pageConstants = new PageConstants(page);
  ...
  When('user paid amount for the apply pass for the company for three month', async ({page}) => {
         const pageConstants = new PageConstants(page);
          await page.waitForLoadState("networkidle");
          await page.waitForTimeout(10000);
  ...
  Then('verify pass apply successfully messge for the company for three month', async ({page}) => {
               const pageConstants = new PageConstants(page);
               await page.waitForLoadState("networkidle");
...
When(/^user select logout button on home page for the company for three month$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForTimeout(2000);
...
Then(/^verify logout verification message for the company for three month$/, async({page}) => {
    const pageConstants = new PageConstants(page);
    await page.waitForLoadState("networkidle");
    await expect(pageConstants.loginPage.enterUsername).toBeVisible();
});

When(/^user approve the apply pass on the list page for the company for three month$/, async({page}) => {
	         const pageConstants = new PageConstants(page);
            await page.waitForLoadState("networkidle");
            await page.waitForTimeout(5000);
...
Then(/^verify pass approved successfully message for the company for three month$/, async({page}) => {
	                const pageConstants = new PageConstants(page);
                  await page.waitForLoadState("networkidle");
                  await page.waitForTimeout(5000);
...
When(/^verify second second approval message for the company three month$/, async({page}) => {
	          const pageConstants = new PageConstants(page);
            await page.waitForTimeout(2000);
            await pageConstants.loginPage.logoutDrop.click();
            await pageConstants.loginPage.logoutButton.click();
...
When(/^verify Third approval message for the company three month$/, async({page}) => {
	          const pageConstants = new PageConstants(page);
            await page.waitForTimeout(2000);
            await pageConstants.loginPage.logoutDrop.click();
            await pageConstants.loginPage.logoutButton.click();
