Feature: Advance search by country Service Availability

  Scenario: Verify the search by country Pass Service functionality
    ...
    Then verify search by visitor nationality
