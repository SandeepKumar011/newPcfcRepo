Feature: Advance search by EID Service Availability

  Scenario: Verify the search by EID Pass Service functionality
    ...
    Then verify search by EID number on list page
